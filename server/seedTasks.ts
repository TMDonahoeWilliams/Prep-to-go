...
const getDefaultTasks = (userId: string, categoryMap: Record<string, string>) => [
  // FAFSA and Financial Aid (Critical Timeline)
  {
    ...
    dueDate: new Date('2025-01-01T23:59:00Z'),
  ...
  // Major Scholarships
  {
    ...
    dueDate: new Date('2024-10-15T23:59:00Z'),
    priority: 'urgent' as const,
    status: 'pending' as const,
  ...
  },
  {
    ...
    dueDate: new Date('2024-10-31T23:59:00Z'),
    priority: 'urgent' as const,
    status: 'pending' as const,
  ...
  },
  {
    ...
    dueDate: new Date('2024-11-15T23:59:00Z'),
    priority: 'urgent' as const,
    status: 'pending' as const,
  ...
  // Testing and Transcripts
  {
    ...
    dueDate: new Date('2024-12-15T23:59:00Z'),
    priority: 'high' as const,
    status: 'pending' as const,
  ...
  },
  {
    ...
    dueDate: new Date('2024-12-01T23:59:00Z'),
    priority: 'high' as const,
    status: 'pending' as const,
  ...
  },
  {
    ...
    dueDate: new Date('2025-07-01T23:59:00Z'),
    priority: 'urgent' as const,
    status: 'pending' as const,
  ...
  // Housing and Health
  {
    ...
    dueDate: new Date('2025-05-01T23:59:00Z'),
    priority: 'high' as const,
    status: 'pending' as const,
