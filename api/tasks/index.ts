...
// Comprehensive default tasks for college prep (realistic deadlines for 2026-2027 academic year)
const defaultTasks = [
  // FAFSA and Financial Aid (Critical Timeline)
  {
    ...
    dueDate: '2026-01-01T23:59:00Z', // Priority deadline for most states
    priority: 'urgent',
    status: 'pending',
    completedAt: null,
  ...
  // Additional Major National Scholarships
  {
    id: 'scholar-4',
    userId: 'demo-user',
    categoryId: 'cat-2',
  ...
  },
  {
    ...
    description: 'Apply for Gates Millennium Scholars Program (full college funding)',
    dueDate: '2026-01-15T23:59:00Z',
    priority: 'high',
    status: 'pending',
    completedAt: null,
    notes: 'For outstanding minority students with financial need. Covers full cost of attendance.',
    assignedTo: 'student',
    createdAt: '2025-10-24T00:00:00Z',
    updatedAt: '2025-10-24T00:00:00Z',
    category: {
  ...
  },
  {
    ...
    description: 'Apply for QuestBridge National College Match (full scholarships to top colleges)',
    dueDate: '2025-09-26T23:59:00Z',
    priority: 'urgent',
    status: 'pending',
    completedAt: null,
    notes: 'High-achieving, low-income students. Partners with 45+ top colleges for full scholarships.',
    assignedTo: 'student',
    createdAt: '2025-10-24T00:00:00Z',
    updatedAt: '2025-10-24T00:00:00Z',
    category: {
  ...
  },
  {
    ...
    description: 'Apply for Elks National Foundation Most Valuable Student Scholarship',
    dueDate: '2025-11-05T23:59:00Z',
    priority: 'high',
    status: 'pending',
    completedAt: null,
    notes: 'Awards up to $12,500/year. Based on scholarship, leadership, and financial need.',
    assignedTo: 'student',
    createdAt: '2025-10-24T00:00:00Z',
    updatedAt: '2025-10-24T00:00:00Z',
    category: {
  ...
  },
  {
    ...
    userId: 'demo-user',
    categoryId: 'cat-2',
    title: '💰 Horatio Alger Association Scholarships',
    description: 'Apply for Horatio Alger Association National Scholarships',
    dueDate: '2025-10-25T23:59:00Z',
    priority: 'urgent',
    status: 'pending',
    completedAt: null,
    notes: 'For students who have overcome adversity. Awards $25,000. Financial need required.',
    assignedTo: 'student',
    createdAt: '2025-10-24T00:00:00Z',
    updatedAt: '2025-10-24T00:00:00Z',
    category: {
  ...
  // State-Specific FAFSA Priority Deadlines
  {
    id: 'fafsa-priority-1',
    userId: 'demo-user',
    categoryId: 'cat-2',
    title: '🚨 FAFSA Priority Deadline - Early States',
    description: 'FAFSA priority deadlines for states with early cutoffs (IL, IN, VT, etc.)',
    dueDate: '2025-11-15T23:59:00Z',
    priority: 'urgent',
    status: 'pending',
    completedAt: null,
    notes: 'Illinois: Nov 15, Indiana: Dec 1, Vermont: varies by school. Check your state deadline!',
    assignedTo: 'parent',
    createdAt: '2025-10-24T00:00:00Z',
    updatedAt: '2025-10-24T00:00:00Z',
    category: {
  ...
  },
  {
    ...
    userId: 'demo-user',
    categoryId: 'cat-2',
    title: '🚨 FAFSA Priority Deadline - Spring States',
    description: 'FAFSA priority deadlines for most states (CA, NY, TX, FL, etc.)',
    dueDate: '2026-03-02T23:59:00Z',
    priority: 'urgent',
    status: 'pending',
    completedAt: null,
    notes: 'California: Mar 2, New York: varies, Texas: Mar 15, Florida: May 15. Submit early for maximum aid!',
    assignedTo: 'parent',
    createdAt: '2025-10-24T00:00:00Z',
    updatedAt: '2025-10-24T00:00:00Z',
    category: {
  ...
  // Additional Important Scholarships (Late Fall/Winter Deadlines)
  {
    id: 'scholar-10',
    userId: 'demo-user',
    categoryId: 'cat-2',
    title: '💰 Dell Scholars Program',
    description: 'Apply for Dell Scholars Program ($20,000 + laptop + textbook credits)',
    dueDate: '2025-12-01T23:59:00Z',
    priority: 'high',
    status: 'pending',
    completedAt: null,
    notes: 'For students participating in approved college readiness programs. Need-based.',
    assignedTo: 'student',
    createdAt: '2025-10-24T00:00:00Z',
    updatedAt: '2025-10-24T00:00:00Z',
    category: {
  ...
  },
  {
    ...
    description: 'Apply for Ron Brown Scholar Program ($40,000 over 4 years)',
    dueDate: '2025-01-09T23:59:00Z',
    priority: 'high',
    status: 'pending',
    completedAt: null,
    notes: 'For African American high school seniors. Academic excellence, leadership, community service.',
    assignedTo: 'student',
    createdAt: '2025-10-24T00:00:00Z',
    updatedAt: '2025-10-24T00:00:00Z',
    category: {
  ...
  },
  {
    ...
    description: 'Apply for Hispanic Scholarship Fund (HSF) General Scholarships',
    dueDate: '2025-02-15T23:59:00Z',
    priority: 'high',
    status: 'pending',
    completedAt: null,
    notes: 'For Hispanic American students. Awards range from $500-$5,000. Multiple scholarships available.',
    assignedTo: 'student',
    createdAt: '2025-10-24T00:00:00Z',
    updatedAt: '2025-10-24T00:00:00Z',
    category: {
  ...
  },
  {
    ...
    description: 'Apply for Burger King Scholars Program ($1,000-$50,000)',
    dueDate: '2025-12-15T23:59:00Z',
    priority: 'medium',
    status: 'pending',
    completedAt: null,
    notes: 'For high school students in US, Puerto Rico, Canada. Based on academic achievement and work experience.',
    assignedTo: 'student',
    createdAt: '2025-10-24T00:00:00Z',
    updatedAt: '2025-10-24T00:00:00Z',
    category: {
